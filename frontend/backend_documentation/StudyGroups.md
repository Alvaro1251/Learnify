...
[
  {
    ...
    "description": "Study group for advanced Python concepts",
    "owner": "user_id_here",
    "members": ["current_user_id", "user_id_2", "user_id_3"],
    "pending_requests": [],
    "is_public": true,
    "exam_date": "2024-12-15T10:00:00",
    "created_at": "2024-10-27T21:30:00",
...
- **owner** - User ID (string) - Stored as ObjectId in MongoDB, returned as string in API responses
- **members** - Array of User IDs (strings) - Stored as ObjectIds in MongoDB, returned as strings in API responses
- **pending_requests** - Array of User IDs (strings) - Stored as ObjectIds in MongoDB, returned as strings in API responses
...
When you make API calls, always use the string user IDs returned in API responses. The backend automatically:
1. Converts string IDs to ObjectIds for database queries
2. Converts ObjectIds back to strings for API responses
3. Ensures proper referential integrity with the users collection
